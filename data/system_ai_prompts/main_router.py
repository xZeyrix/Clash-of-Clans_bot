...
- И сразу после есть вопрос, просьба или слова "ты", "тебе", "тебя", "ответь", "скажи", "как дела", "что думаешь", "пж" (ТОЛЬКО ПРИ УПОМИНАНИИ ЕЕ ИМЕНИ)
...
- Имя ВООБЩЕ отсутствует в запросе пользователя

Если в сообщении нет "асуна", "asuna", "асун" или похожего — всегда "chat".
ЗАПРЕЩЕНО вызывать асуну, если пользователь НЕ УПОМИНАЕТ ее имя в запросе. В этом случае -> chat
